...
Свойство AliveCreatures создаёт список живых существ из списка всех существ, а свойство IsInBreedZone также его использует. Данные свойтсва вызываются довольно часто в коде и происходит много лишних аллокаций временных списков.
...
Была обнаружена проблема - частый вызов ToArray() после взаимодействия со свойстом Genotype у Chromosome. Изменим возвращаемы1 тип у свойства с IReadOnlyCollection<IGene> на IGene[] и уберём лишние вызовы ToArray().
